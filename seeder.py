...
author = User(name = "iHDeveloper", email = "hamzadevelop@gmail.com", picture = "test_picture")
session.add(author)
session.commit()
...
mouses_v1 = item("Mouse V2", mouses.id, "The second version of the mouse item.")

keyboards = catalog("Keyboard", author.id)
keyboard_v1 = item("KeyBoard V1", keyboards.id, "The first version of keyboard")
keyboard_v1 = item("KeyBoard V2", keyboards.id, "The second version of keyboard")
